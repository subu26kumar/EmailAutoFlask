...
#                             file_path = os.path.join(r"C:\Users\Hostbooks\Desktop\EmailAutoFlask\static\excel", file_name)
...
#     return render_template("Excel.html", dir_list=dir_list, path=path)
def list():
    # dir_list = os.scandir(r"C:\Users\Hostbooks\Desktop\EmailAutoFlask\static\excel")
    # path = r"C:\Users\Hostbooks\Desktop\EmailAutoFlask\static\excel/"
    print("started")
    entries = os.listdir(r"C:/Users/Hostbooks/Desktop/EmailAutoFlask/junk/")
    print(type(entries))
    for entry in entries:
        print(entry)
    return render_template("listFile.html", entries=entries)
@app.route('/view/<path>')
def view(path):
   
    filepath="C:/Users/Hostbooks/Desktop/EmailAutoFlask/junk/"+path
